...
// Import only the modern Tailwind colors we need (avoiding deprecated names)
// Deprecated: lightBlue → sky, warmGray → stone, trueGray → neutral, coolGray → gray, blueGray → slate
const defaultColors = {
  inherit: 'inherit',
