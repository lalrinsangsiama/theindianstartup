...
const badges = [
  {
    ...
    requirementValue: { dayRequired: 1 },
  },
  {
    code: 'RESEARCHER',
    title: 'Researcher',
    ...
    icon: '🔍',
    requirementType: 'manual',
    requirementValue: { dayRequired: 3 },
  },
  {
    code: 'BRAND_BUILDER',
    title: 'Brand Builder',
    ...
    icon: '🎨',
    requirementType: 'manual',
    requirementValue: { dayRequired: 8 },
  },
  {
    code: 'LEGALLY_READY',
    title: 'Legally Ready',
    ...
    icon: '📋',
    requirementType: 'manual',
    requirementValue: { dayRequired: 10 },
  },
  {
    code: 'MVP_MASTER',
    title: 'MVP Master',
    ...
    icon: '🛠️',
    requirementType: 'manual',
    requirementValue: { dayRequired: 19 },
  },
  {
    ...
    requirementValue: { xpRequired: 500 },
  },
  {
    code: 'COMPLIANCE_HERO',
    title: 'Compliance Hero',
    description: 'Complete all regulatory tasks',
    icon: '✅',
    requirementType: 'manual',
    requirementValue: { dayRequired: 21 },
  },
  {
    code: 'SALES_STARTER',
    title: 'Sales Starter',
    ...
    icon: '💰',
    requirementType: 'xp_threshold',
    requirementValue: { xpRequired: 800 },
  },
  {
    code: 'PITCH_PERFECT',
    title: 'Pitch Perfect',
    ...
    icon: '📊',
    requirementType: 'manual',
    requirementValue: { dayRequired: 29 },
  },
  {
    code: 'LAUNCH_LEGEND',
    title: 'Launch Legend',
    ...
    icon: '🏆',
    requirementType: 'manual',
    requirementValue: { dayRequired: 30 },
  },
];
